...
describe("SystemTesting0", function () {
    ...
    before("Initial set up", async function () {
        ...
        await factory.deployGumBall('GBT1', 'GBT1', ['testuri', 'testURI'], oneHundred, oneHundred, weth.address, artist.address, 0, [100, 100]);
    ...
    it('User1 sells rest of GBT except for two', async function () {
        console.log("******************************************************");
